        ...
        <div class="lg:rounded-2xl bg-white dark:bg-[#111111]">
                ...
                <div class="lg:hidden">
                    <div class="w-full mb-6 lg:mb-0 mx-auto relative bg-white text-center dark:bg-[#111111] px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0">
                        ...
                        <div class="pt-[100px] pb-8">
                            <h2 class="mt-6 mb-1 text-[26px] font-semibold dark:text-white"> Jorge Corzo Sample
                            </h2>
            ...
            <div class="px-2 sm:px-5 md:px-10 lg:px-14">
                <div class="bg-[#F8FBFB] dark:bg-[#0D0D0D] max-w-full h-auto py-10 rounded-xl">
                    ...
                    <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 3798px; transform: translate3d(-1477px, 0px, 0px);"><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="-4" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand3.png" alt="brand icon">
                        </div><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="-3" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand4.png" alt="brand icon">
                        </div><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="-2" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand1.png" alt="brand icon">
                        </div><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="-1" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand1.png" alt="brand icon">
                        </div><div class="slick-slide" style="width: 211px;" tabindex="-1" data-slick-index="0" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand.png" alt="brand icon">
                        </div><div class="slick-slide" style="width: 211px;" tabindex="-1" data-slick-index="1" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand1.png" alt="brand icon">
                        </div><div class="slick-slide" style="width: 211px;" tabindex="-1" data-slick-index="2" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand2.png" alt="brand icon">
                        </div><div class="slick-slide slick-current slick-active" style="width: 211px;" tabindex="0" data-slick-index="3" aria-hidden="false">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand3.png" alt="brand icon">
                        </div><div class="slick-slide slick-active" style="width: 211px;" tabindex="0" data-slick-index="4" aria-hidden="false">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand4.png" alt="brand icon">
                        </div><div class="slick-slide slick-active" style="width: 211px;" tabindex="0" data-slick-index="5" aria-hidden="false">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand1.png" alt="brand icon">
                        </div><div class="slick-slide slick-active" style="width: 211px;" tabindex="0" data-slick-index="6" aria-hidden="false">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand1.png" alt="brand icon">
                        </div><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="7" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand.png" alt="brand icon">
                        </div><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="8" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand1.png" alt="brand icon">
                        </div><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="9" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand2.png" alt="brand icon">
                        </div><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="10" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand3.png" alt="brand icon">
                        </div><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="11" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand4.png" alt="brand icon">
                        </div><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="12" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand1.png" alt="brand icon">
                        </div><div class="slick-slide slick-cloned" style="width: 211px;" tabindex="-1" data-slick-index="13" id="" aria-hidden="true">
                            <img class="overflow-hidden brand-img" src="./images/slider/brand1.png" alt="brand icon">
                        </div></div></div></div>
