<section id="portfolio" class="bg-white   lg:rounded-2xl dark:bg-[#111111]">
    <div class="container  mb-8 px-4 sm:px-5 md:px-10 lg:px-[60px]">
        ...
        <div id="isotop-gallery-wrapper" class="mymix portfolio_list-two  two-col " style="position: relative; height: 1514.2px;">
            ...
            <div class="portfolio_list-two-items isotop-item dev branding " style="position: absolute; left: 49.9168%; top: 0px;">
            ...
            <div class="portfolio_list-two-items isotop-item plugin " style="position: absolute; left: 0%; top: 273px;">
                <div class="rounded-lg bg-[#fff3fc] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                    <div class="overflow-hidden rounded-lg">
            ...
            <div class="portfolio_list-two-items isotop-item dev custom " style="position: absolute; left: 49.9168%; top: 347px;">
            ...
            <div class="portfolio_list-two-items isotop-item branding " style="position: absolute; left: 0%; top: 583px;">
            ...
            <div class="portfolio_list-two-items isotop-item branding " style="position: absolute; left: 49.9168%; top: 694px;">
            ...
            <div class="portfolio_list-two-items isotop-item plugin " style="position: absolute; left: 0%; top: 893px;">
                <div class="rounded-lg bg-[#f4f4ff] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                    <div class="overflow-hidden rounded-lg">
            ...
            <div class="portfolio_list-two-items isotop-item dev branding " style="position: absolute; left: 49.9168%; top: 1041px;">
                <div class="rounded-lg bg-[#f4f4ff] dark:bg-transparent p-6 dark:border-[2px] border-[#212425]">
                    <div class="overflow-hidden rounded-lg">
            ...
            <div class="portfolio_list-two-items isotop-item plugin custom " style="position: absolute; left: 0%; top: 1203px;">
